...
import static org.smartregister.unicefangola.util.AppConstants.DatabaseKeys.SYNC_STATUS;
import static org.smartregister.unicefangola.util.AppConstants.DatabaseKeys.VALIDATION_STATUS;
import static org.smartregister.unicefangola.util.AppConstants.SyncInfo.INVALID_CLIENTS;
import static org.smartregister.unicefangola.util.AppConstants.SyncInfo.INVALID_EVENTS;
import static org.smartregister.unicefangola.util.AppConstants.SyncInfo.NULL_EVENT_SYNC_STATUS;
import static org.smartregister.unicefangola.util.AppConstants.SyncInfo.SYNCED_CLIENTS;
import static org.smartregister.unicefangola.util.AppConstants.SyncInfo.SYNCED_EVENTS;
import static org.smartregister.unicefangola.util.AppConstants.SyncInfo.TASK_UNPROCESSED_EVENTS;
import static org.smartregister.unicefangola.util.AppConstants.SyncInfo.UNSYNCED_CLIENTS;
import static org.smartregister.unicefangola.util.AppConstants.SyncInfo.UNSYNCED_EVENTS;
import static org.smartregister.unicefangola.util.AppConstants.SyncInfo.VALID_CLIENTS;
import static org.smartregister.unicefangola.util.AppConstants.SyncInfo.VALID_EVENTS;
...
public class StatsFragmentInteractor implements StatsFragmentContract.Interactor {
    ...
    public StatsFragmentInteractor(StatsFragmentContract.Presenter presenter) {
        ...
        appExecutors = UnicefAngolaApplication.getInstance().getAppExecutors();
        database = UnicefAngolaApplication.getInstance().getRepository().getReadableDatabase();
    }
